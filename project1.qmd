...
## Conclusion: Gauss-Markov Theorem

Since OLS is:
1. Unbiased: $\mathbb{E}[\hat{\beta}_{\text{OLS}}] = \beta$  
...
Assuming $X^T X$ is invertible (i.e., $\det(X^T X) \neq 0$):
...
if determinant == 0:
    ...
    # Solve for beta using the closed-form OLS solution
...
![](images/Bias Comparison.png){width=70%}
</div>

<br>

<div style="text-align: center;">
![](images/Variance Comparison.png){width=70%}
</div>

<br>

<div style="text-align: center;">
![](images/MSE Comparison.png){width=70%}
</div>
...
![](images/Non-Linear MSE Comparison.png){width=60%}
