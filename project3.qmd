...
huber_oof=np.load('oof_preds_huber.npy')
huber_test=np.load("test_preds_huber.npy")
# === Targets and prediction stack ===
y_meta = train['TARGET'].values
X_base = np.vstack([oof_xgb, ridge_oof,oof_lgb,huber_oof]).T
X_test_base = np.vstack([test_xgb, ridge_test_preds,test_lg,huber_test]).T
